...
//		HeroCollection.prepareHeroesTileId(loader);
	...
	private static void prepareTilesets(DynamicTileLoader loader, int mTileSize) {
		...
		final Size sz20x4 = new Size(20, 4);
		...
		loader.prepareTileset(R.drawable.map_62, "map_62", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_63, "map_63", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_64, "map_64", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_65, "map_65", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_66, "map_66", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_67, "map_67", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_68, "map_68", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_69, "map_69", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_7, "map_7", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_70, "map_70", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_71, "map_71", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_72, "map_72", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_73, "map_73", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_74, "map_74", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.map_75, "map_75", sz8x8, sz1x1, mTileSize);
		...
		loader.prepareTileset(R.drawable.obj_17, "obj_17", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.obj_18, "obj_18", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.obj_19, "obj_19", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.obj_2, "obj_2", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.obj_20, "obj_20", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.obj_21, "obj_21", sz8x8, sz1x1, mTileSize);
		loader.prepareTileset(R.drawable.obj_22, "obj_22", sz8x8, sz1x1, mTileSize);
